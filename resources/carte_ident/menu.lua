...
Menu.item = {
    ['Title'] = 'Interaction',
    ['Items'] = {
                {['Title'] = 'Carte Identité', ['SubMenu'] = {
            ['Title'] = 'Menu',
                ['Items'] = {
                    { ['Title'] = 'Montrer ses papiers', ['Event'] = 'gcl:openMeIdentity'},
                }
            }
        }
        -- {['Title'] = 'Politi', ['SubMenu'] = {
            -- ['Title'] = 'Politi Menu',
                -- ['Items'] = {
                    -- { ['Title'] = 'Vis ID', ['Event'] = 'gc:openIdentity'},
                    -- { ['Title'] = 'Søg', ['Event'] = 'police:targetCheckInventory'},
                    -- { ['Title'] = 'Tjek Nummerplade', ['Event'] = 'police:targetCheckInventory'},
                    -- { ['Title'] = 'Håndjern', ['Event'] = 'police:cuff'},
                    -- { ['Title'] = 'Tving', ['Event'] = 'police:forceEnter'},
                -- }
            -- }
        -- }
    }
