	...
	menu = {
		...
		["main"] = {
			...
			buttons = {
				...
				{title = "SMG", name = "MachineGuns", description = ""},
		...
		["Melee"] = {
			...
			name = "Melee",
			buttons = {
				{title = "Couteau", name = "Knife", costs = 500, description = {}, model = "WEAPON_Knife"},
				...
				{title = "Pied-de-biche", name = "Crowbar", costs = 800, description = {}, model = "WEAPON_Crowbar"},
				{title = "Club de golf", name = "Golfclub", costs = 700, description = {}, model = "WEAPON_Golfclub"},
				{title = "Bouteille", name = "Bottle", costs = 500, description = {}, model = "WEAPON_Bottle"},
				{title = "Dague ancienne", name = "Dagger", costs = 1000, description = {}, model = "WEAPON_Dagger"},
				...
				{title = "Lampe torche", name = "Flashlight", costs = 500, description = {}, model = "WEAPON_Flashlight"},
				{title = "Couteau papillon", name = "SwitchBlade", costs = 650, description = {}, model = "WEAPON_SwitchBlade"},
		...
		["Pistolets"] = {
			...
			name = "Pistolets",
			buttons = {
				{title = ".9mm", name = "Pistol", costs = 8500, description = {}, model = "WEAPON_Pistol"},
				{title = "Glock .9mm", name = "CombatPistol", costs = 9250, description = {}, model = "WEAPON_CombatPistol"},
				{title = "Calibre .50", name = "Pistol50", costs = 10000, description = {}, model = "WEAPON_PISTOL50"},
				{title = "Pétoir", name = "SNSPistol", costs = 8000, description = {}, model = "WEAPON_SNSPistol"},
				{title = "Pistolet Lourd", name = "HeavyPistol", costs = 12000, description = {}, model = "WEAPON_HeavyPistol"},
				{title = "Pistolet Vintage", name = "VintagePistol", costs = 13000, description = {}, model = "WEAPON_VintagePistol"},
				--{title = "Marksman Pistol", name = "MarksmanPistol", costs = 2000, description = {}, model = "WEAPON_MarksmanPistol"},
				{title = "Revolver", name = "Revolver", costs = 12000, description = {}, model = "WEAPON_Revolver"},
		...
		["MachineGuns"] = {
			...
			buttons = {
				...
				{title = "MP5", name = "SMG", costs = 35000, description = {}, model = "WEAPON_SMG"},
				--{title = "Assault SMG", name = "AssaultSMG", costs = 18000, description = {}, model = "WEAPON_AssaultSMG"},
				{title = "PDW de combat", name = "CombatPDW", costs = 35000, description = {}, model = "WEAPON_CombatPDW"},
				...
				{title = "Gusenberg", name = "Gusenberg", costs = 45000, description = {}, model = "WEAPON_Gusenberg"},
		...
		["Shotguns"] = {
			...
			name = "Shotguns",
			buttons = {
				{title = "Shotgun standard", name = "PumpShotgun", costs = 30000, description = {}, model = "WEAPON_PumpShotgun"},
				{title = "SPAS-12", name = "SawnoffShotgun", costs = 35000, description = {}, model = "WEAPON_SawnoffShotgun"},
				...
				{title = "Mousquet", name = "Musket", costs = 25000, description = {}, model = "WEAPON_Musket"},
		...
		["AssaultRifles"] = {
			...
			name = "AssaultRifles",
			buttons = {
				{title = "Assault Rifle", name = "AssaultRifle", costs = 60000, description = {}, model = "WEAPON_AssaultRifle"},
				{title = "Carbine Rifle", name = "CarbineRifle", costs = 60000, description = {}, model = "WEAPON_CarbineRifle"},
		...
		["ThrownWeapons"] = {
			...
			buttons = {
				...
				{title = "Molotov", name = "Molotov", costs = 1500, description = {}, model = "WEAPON_Molotov"},
				{title = "Exctincteur", name = "FireExtinguisher", costs = 500, description = {}, model = "WEAPON_FireExtinguisher"},
				{title = "Jerrican d'essence", name = "PetrolCan", costs = 500, description = {}, model = "WEAPON_PetrolCan"},
				...
				{title = "Boule de neige", name = "Snowball", costs = 20, description = {}, model = "WEAPON_Snowball"},
