	...
	menu = {
		...
		["compacts"] = {
			...
			buttons = {
				...
				{name = "Brioso R/A", costs = 40000, description = {}, model = "brioso"},
				{name = "Dilettante", costs = 11000, description = {}, model = "Dilettante"},
				{name = "Issi", costs = 16000, description = {}, model = "issi2"},
		...
		["coupes"] = {
			...
			name = "coupes",
			buttons = {
				{name = "Cognoscenti Cabrio", costs = 160000, description = {}, model = "cogcabrio"},
				{name = "Exemplar", costs = 175000, description = {}, model = "exemplar"},
				{name = "F620", costs = 100000, description = {}, model = "f620"},
				{name = "Felon", costs = 90000, description = {}, model = "felon"},
				{name = "Felon GT", costs = 105000, description = {}, model = "felon2"},
				{name = "Jackal", costs = 60000, description = {}, model = "jackal"},
				{name = "Oracle", costs = 45000, description = {}, model = "oracle"},
				{name = "Oracle XS", costs = 60000, description = {}, model = "oracle2"},
				{name = "Sentinel", costs = 60000, description = {}, model = "sentinel"},
				{name = "Sentinel XS", costs = 90020, description = {}, model = "sentinel2"},
				{name = "Windsor", costs = 190000, description = {}, model = "windsor"},
				{name = "Windsor Drop", costs = 220000, description = {}, model = "windsor2"},
		...
		["sports"] = {
			...
			buttons = {
				...
				{name = "Banshee", costs = 120000, description = {}, model = "banshee"},
			...
			--	{name = "Blista Compact", costs = 42000, description = {}, model = "blista"},
				...
				{name = "Carbonizzare", costs = 200000, description = {}, model = "carbonizzare"},
				{name = "Comet", costs = 140000, description = {}, model = "comet2"},
				{name = "Coquette", costs = 138000, description = {}, model = "coquette"},
				{name = "Drift Tampa", costs = 300000, description = {}, model = "tampa2"},
				...
				{name = "Jester", costs = 108000, description = {}, model = "jester"},
			--	{name = "Jester(Racecar)", costs = 350000, description = {}, model = "jester2"},
				...
				{name = "Massacro", costs = 220000, description = {}, model = "massacro"},
			--	{name = "Massacro(Racecar)", costs = 385000, description = {}, model = "massacro2"},
				{name = "Omnis", costs = 280000, description = {}, model = "omnis"},
				{name = "Penumbra", costs = 26050, description = {}, model = "penumbra"},
				{name = "Rapid GT", costs = 140000, description = {}, model = "rapidgt"},
				{name = "Rapid GT Convertible", costs = 150000, description = {}, model = "rapidgt2"},
				{name = "Schafter V12", costs = 155000, description = {}, model = "schafter3"},
				{name = "Sultan", costs = 80000, description = {}, model = "sultan"},
				{name = "Surano", costs = 110000, description = {}, model = "surano"},
				{name = "Tropos", costs = 205000, description = {}, model = "tropos"},
				{name = "Verkierer", costs = 350000, description = {}, model = "verlierer2"},
			}
		},
		["sportsclassics"] = {
			...
			name = "sportsclassics",
			buttons = {
				{name = "Casco", costs = 300000, description = {}, model = "casco"},
				{name = "Coquette Classic", costs = 400000, description = {}, model = "coquette2"},
				{name = "JB 700", costs = 350000, description = {}, model = "jb700"},
				{name = "Pigalle", costs = 150000, description = {}, model = "pigalle"},
				{name = "Stinger", costs = 350000, description = {}, model = "stinger"},
				{name = "Stinger GT", costs = 375000, description = {}, model = "stingergt"},
				{name = "Stirling GT", costs = 360000, description = {}, model = "feltzer3"},
				{name = "Z-Type", costs = 450000, description = {}, model = "ztype"},
			}
		},
		["super"] = {
			title = "super",
			...
			buttons = {
				...
				{name = "Bullet", costs = 250000, description = {}, model = "bullet"},
				{name = "Cheetah", costs = 650000, description = {}, model = "cheetah"},
				{name = "Entity XF", costs = 695000, description = {}, model = "entityxf"},
				{name = "ETR1", costs = 500500, description = {}, model = "sheava"},
				{name = "FMJ", costs = 1250000, description = {}, model = "fmj"},
				{name = "Infernus", costs = 360000, description = {}, model = "infernus"},
				{name = "Osiris", costs = 1240000, description = {}, model = "osiris"},
				{name = "RE-7B", costs = 1000002, description = {}, model = "le7b"},
				{name = "Reaper", costs = 795000, description = {}, model = "reaper"},
				{name = "Sultan RS", costs = 780000, description = {}, model = "sultanrs"},
				{name = "T20", costs = 1300000, description = {}, model = "t20"},
				{name = "Turismo R", costs = 600000, description = {}, model = "turismor"},
				{name = "Tyrus", costs = 1350000, description = {}, model = "tyrus"},
				{name = "Vacca", costs = 280000, description = {}, model = "vacca"},
				{name = "Voltic", costs = 175000, description = {}, model = "voltic"},
				{name = "X80 Proto", costs = 2000000, description = {}, model = "prototipo"},
				{name = "Zentorno", costs = 1800000, description = {}, model = "zentorno"},
			}
		},
		["muscle"] = {
			title = "muscle",
			...
			buttons = {
				...
				{name = "Chino", costs =35000, description = {}, model = "chino"},
				{name = "Coquette BlackFin", costs = 200000, description = {}, model = "coquette3"},
				{name = "Dominator", costs = 40000, description = {}, model = "dominator"},
				{name = "Dukes", costs = 33000, description = {}, model = "dukes"},
				{name = "Gauntlet", costs = 35000, description = {}, model = "gauntlet"},
				{name = "Hotknife", costs = 90000, description = {}, model = "hotknife"},
				{name = "Faction", costs = 24000, description = {}, model = "faction"},
				{name = "Nightshade", costs = 185000, description = {}, model = "nightshade"},
				{name = "Picador", costs = 9000, description = {}, model = "picador"},
				{name = "Sabre Turbo", costs = 30000, description = {}, model = "sabregt"},
				{name = "Tampa", costs = 27000, description = {}, model = "tampa"},
				{name = "Virgo", costs = 33000, description = {}, model = "virgo"},
		...
		["offroad"] = {
			...
			name = "off-road",
			buttons = {
				{name = "Bifta", costs = 65000, description = {}, model = "bifta"},
				{name = "Blazer", costs = 8000, description = {}, model = "blazer"},
				{name = "Brawler", costs = 140000, description = {}, model = "brawler"},
				{name = "Bubsta 6x6", costs = 240000, description = {}, model = "dubsta3"},
		...
		["suvs"] = {
			...
			buttons = {
				...
				{name = "Grabger", costs = 85000, description = {}, model = "granger"},
				{name = "Huntley S", costs = 195000, description = {}, model = "huntley"},
				{name = "Landstalker", costs = 50000, description = {}, model = "landstalker"},
				{name = "Radius", costs = 60000, description = {}, model = "radi"},
				{name = "Rocoto", costs = 55000, description = {}, model = "rocoto"},
				{name = "Seminole", costs = 50000, description = {}, model = "seminole"},
				{name = "XLS", costs = 75000, description = {}, model = "xls"},
			}
		},
		["vans"] = {
			title = "vans",
			...
			buttons = {
				...
				{name = "Minivan", costs = 22000, description = {}, model = "minivan"},
				{name = "Paradise", costs = 25000, description = {}, model = "paradise"},
				{name = "Rumpo", costs = 13000, description = {}, model = "rumpo"},
				{name = "Surfer", costs = 19000, description = {}, model = "surfer"},
		...
		["sedans"] = {
			...
			buttons = {
				...
				{name = "Asterope", costs = 23000, description = {}, model = "asterope"},
				{name = "Fugitive", costs = 35000, description = {}, model = "fugitive"},
				{name = "Glendale", costs = 18000, description = {}, model = "glendale"},
				{name = "Ingot", costs = 13500, description = {}, model = "ingot"},
				{name = "Intruder", costs = 21000, description = {}, model = "intruder"},
				{name = "Premier", costs = 18000, description = {}, model = "premier"},
				{name = "Primo", costs = 13000, description = {}, model = "primo"},
				{name = "Primo Custom", costs = 26000, description = {}, model = "primo2"},
				{name = "Regina", costs = 9500, description = {}, model = "regina"},
				{name = "Schafter", costs = 60000, description = {}, model = "schafter2"},
				{name = "Stanier", costs = 11000, description = {}, model = "stanier"},
				{name = "Stratum", costs = 12000, description = {}, model = "stratum"},
				{name = "Stretch", costs = 100000, description = {}, model = "stretch"},
				{name = "Super Diamond", costs = 250000, description = {}, model = "superd"},
				{name = "Surge", costs = 29000, description = {}, model = "surge"},
				{name = "Tailgater", costs = 25000, description = {}, model = "tailgater"},
		...
		["motorcycles"] = {
			...
			name = "motorcycles",
			buttons = {
				{name = "Akuma", costs = 45000, description = {}, model = "AKUMA"},
				{name = "Bagger", costs = 60000, description = {}, model = "bagger"},
				{name = "Bati 801", costs = 60000, description = {}, model = "bati"},
			--	{name = "Bati 801RR", costs = 15000, description = {}, model = "bati2"},
				...
				{name = "Nemesis", costs = 34000, description = {}, model = "nemesis"},
				{name = "PCJ-600", costs = 25000, description = {}, model = "pcj"},
				{name = "Ruffian", costs = 45000, description = {}, model = "ruffian"},
				...
				{name = "Vindicator", costs = 120000, description = {}, model = "vindicator"},
			}
		},
	}
}
