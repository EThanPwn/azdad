	...
	['sandyshores1'] = {
		...
		['vinewood1'] = {
			...
			['stock'] = {
				...
				["WEAPON_SNSPISTOL"] = 17000,
				["WEAPON_VINTAGEPISTOL"] = 25000,
				["WEAPON_PISTOL"] = 15000,
				["WEAPON_COMBATPISTOL"] = 30000,
		...
		['delperro1'] = {
			...
			['stock'] = {
				...
				["WEAPON_HATCHET"] = 8500,
				["WEAPON_CROWBAR"] = 8000,
				["WEAPON_GOLFCLUB"] = 7500,
				["WEAPON_SWITCHBLADE"] = 9000,
				["WEAPON_MACHETE"] = 9000,
			}
		},
		...
		['vespuccibeach1'] = {
			...
			['stock'] = {
				...
				["WEAPON_SMG"] = 50000,
				["WEAPON_ASSAULTSMG"] = 95000,
				["WEAPON_COMBATPDW"] = 75000,
				["WEAPON_MACHINEPISTOL"] = 45000,
			}
		},
		...
		['paletobay1'] = {
			...
			['stock'] = {
				["WEAPON_COMPACTRIFLE"] = 175000,
				["WEAPON_ASSAULTRIFLE"] = 200000,
				["WEAPON_BULLPUPRIFLE"] = 200000,
				["WEAPON_ADVANCEDRIFLE"] = 220000,
		...
		['chumash1'] = {
			...
			['stock'] = {
				["WEAPON_MARKSMANRIFLE"] = 250000,
				["WEAPON_SNIPERRIFLE"] = 350000,
		...
		['greatchaparral1'] = {
			...
			['stock'] = {
				["WEAPON_PETROLCAN"] = 75000,
				["WEAPON_FIREEXTINGUISHER"] = 9500,
				["WEAPON_SNOWBALL"] = 30000,
			}
		},
...
MySQL:open("127.0.0.1", "gta5_script_weaponshop", "root", "18020603")
...
AddEventHandler('es_roleplay:buySnack', function(s)
	...
	TriggerEvent('es:getPlayerFromId', source, function(user)
		...
		if(get3DDistance(pos.x, pos.y, pos.z, lpos.x, lpos.y, lpos.z) < 2.0)then
			if(user.money > 29)then
				user:removeMoney(30)
				TriggerClientEvent('chatMessage', source, 'SHOP', {255, 0, 0}, "Tu es maintenant en pleine forme.")
