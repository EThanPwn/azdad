...
local weaponNames = 
		...
		WEAPON_PISTOL = "m9", 
		WEAPON_SMG = "MP5", 
		WEAPON_MARKSMANPISTOL = "Pistolet de precision", 
		WEAPON_SNSPISTOL = "Petoire", 
		WEAPON_VINTAGEPISTOL = "Pistolet vintage", 
		WEAPON_COMBATPISTOL = "Pistolet de combat", 
		WEAPON_HEAVYPISTOL = "m1911", 
		WEAPON_HEAVYREVOLVER = "Revolver .44", 
		WEAPON_APPISTOL = "Pistolet perforant", 
		WEAPON_BOTTLE = "Bouteille", 
		WEAPON_BAT = "Batte de Baseball", 
		WEAPON_BAT = "Batte de Baseball", 
		WEAPON_KNUCKLE = "Poing americain", 
		WEAPON_KNIFE = "Couteau", 
		WEAPON_DAGGER = "Dague", 
		WEAPON_HAMMER = "Marteau", 
		WEAPON_HATCHET = "Hatchette", 
		WEAPON_NIGHTSTICK = "Tonfa", 
		WEAPON_CROWBAR = "Pied de biche", 
		WEAPON_GOLFCLUB = "Club de golf", 
		WEAPON_SWITCHBLADE = "Couteaux papillon", 
		WEAPON_MACHETE = "Machette", 
		WEAPON_MICROSMG = "Uzi", 
		WEAPON_ASSAULTSMG = "Magpul PDR", 
		WEAPON_COMBATPDW = "Mitrailleuse de Combat", 
		WEAPON_MACHINEPISTOL = "TEC-9", 
		WEAPON_COMPACTRIFLE = "AKM-SU", 
		WEAPON_ASSAULTRIFLE = "AK47", 
		WEAPON_CARBINERIFLE = "M4", 
		WEAPON_BULLPUPRIFLE = "Type 95", 
		WEAPON_ADVANCEDRIFLE = "Tar-21", 
		WEAPON_SPECIALCARBINE = "G36C", 
		WEAPON_GUSENBERG = "Thompson", 
		WEAPON_MG = "PKP Pecheneg", 
		WEAPON_COMBATMG = "M249", 
		WEAPON_SNIPERRIFLE = "Fusil de precision", 
		WEAPON_MARKSMANRIFLE = "M39 EMR", 
		WEAPON_HEAVYSNIPER = "Barrett .50", 
		WEAPON_MOLOTOV = "Cocktail Molotov", 
		WEAPON_FLARE = "Fusee eclairante", 
		WEAPON_GRENADE = "Grenade", 
		WEAPON_SAWNOFFSHOTGUN = "Sawed-off", 
		WEAPON_PUMPSHOTGUN = "Fusil a pompe", 
		WEAPON_BULLPUPSHOTGUN = "KSG", 
		WEAPON_HEAVYSHOTGUN = "Saiga-12", 
		WEAPON_ASSAULTSHOTGUN = "Fusil a pompe d assaut", 
		WEAPON_SMOKEGRENADE = "Grenade lacrymogene", 
		WEAPON_PETROLCAN = "Jerrican", 
		WEAPON_GRENADELAUNCHER_SMOKE = "Lance grenades", 
